...
void main() {
  group('Bottom Navigation Bar Golden Tests (Implementation-Aware)', () {
    setUpAll(() async {
      await loadAppFonts();
    });

    testGoldens(
        'NavBar/Navigation - ResponsiveLayoutBuilder (mobile/tablet/desktop)',
        (tester) async {
      int selectedIndex = 0;
      ...
      await screenMatchesGolden(tester, 'nav_bar_responsive_mobile');
      ...
      expect(find.byType(NavBar), findsOneWidget);
      expect(find.byType(NavRail), findsNothing);
      await screenMatchesGolden(tester, 'nav_bar_responsive_tablet');
      ...
      await screenMatchesGolden(tester, 'nav_bar_responsive_desktop');
