...
void main() {
  group('Navigation Components Golden Tests (Implementation-Aware)', () {
    setUpAll(() async {
      await loadAppFonts();
    });
    ...
    testGoldens('Navigation - ResponsiveLayoutBuilder (mobile/tablet/desktop)',
      ...
      await screenMatchesGolden(tester, 'navigation_responsive_mobile');
      ...
      expect(find.byType(NavBar), findsOneWidget);
      expect(find.byType(NavRail), findsNothing);
      await screenMatchesGolden(tester, 'navigation_responsive_tablet');
      ...
      await screenMatchesGolden(tester, 'navigation_responsive_desktop');
